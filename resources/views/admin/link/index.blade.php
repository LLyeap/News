...
@section('scripts')
    ...
    <script>
        ...
        getData('http://admin.mysite.com/link_info?totalPage=&nowPage=1');
        ...
        $(document).on('click','#update',function(){
            ...
            $.ajax({
                url: 'link/' + update_id + '/edit',
                type: 'GET',
                data: {},
                success: function (data) {
                    if (data.ServerNo == 200) {
                        $('#myModalTitle').html('修改友链: ' + data.ResultData.name + '的信息');
