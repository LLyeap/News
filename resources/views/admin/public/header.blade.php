        ...
        <ul class="nav navbar-nav navbar-right top-menu top-right-menu">
            ...
            <li class="dropdown text-center">
                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    ...
                    <span class="username">{{ Session::get('admin')->email }}</span> <span class="caret"></span>
                </a>
                <ul class="dropdown-menu pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                    <li><a href="#"><i class="fa fa-cog"></i> 上一次登陆时间：{{ date('Y年m月d日 H:i:s',Session::get('admin')->last_login_time) }}</a></li>
                    <li><a href="#"><i class="fa fa-bell"></i> 上一次登陆IP：{{ Session::get('admin')->last_login_ip }}</a></li>
