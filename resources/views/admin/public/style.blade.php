<!-- 自定义清除浏览器默认样式-在顶部引入 -->
<link href="{{ asset('common/css/reset.css') }}" rel="stylesheet" />
...
<!-- sweet alerts -->
<link href="{{ asset('admin/public/css/sweet-alert.min.css') }}" rel="stylesheet" />

<!-- Plugins css 信息提示框 必须添加 -->
<link href="{{ asset('admin/public/css/component.css') }}" rel="stylesheet" />
<!-- 这个模板的自定义样式 -->
<link href="{{ asset('admin/public/css/style.css') }}" rel="stylesheet" />
<link href="{{ asset('admin/public/css/helper.css') }}" rel="stylesheet" />
