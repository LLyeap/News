            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-solid">
                        {{-- 表单开始 --}}
                        <form role="form" method="POST" action="{{ url('nav') }}" id="page-form">
                            {{ csrf_field() }}
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="name">链接名 (Name)</label>
                                    <div class="row">
                                        <div class='col-md-6'>
                                            <input type='text' class='form-control' name="name" id='name' placeholder='链接名 (Name)'>
                                        </div>
                                    </div>
                                </div>
