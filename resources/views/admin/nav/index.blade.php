...
@section('scripts')
    ...
    <script>
        ...
        getData('http://admin.mysite.com/nav_info?totalPage=&nowPage=1');
        ...
        $(document).on('click','#update',function(){
            ...
            $.ajax({
                url: 'nav/' + update_id + '/edit',
                type: 'GET',
                data: {},
                success: function (data) {
                    if (data.ServerNo == 200) {
                        $('#myModalTitle').html('修改导航: ' + data.ResultData.name + '的信息');
